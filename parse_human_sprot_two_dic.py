...
with codecs.open(uniprot_kb_file,'r','utf8') as kbf:
    ...
    for line in kbf:
        ...
        if line.startswith('AC   '):
            ...
            for idi in id_list:
                uniprot_kb_protein_dic[idi]=[]
                uniprot_kb_gene_dic[idi]=[]
            print(id_list)
            ...
            print(name_list)
            for idi in id_list:
                uniprot_kb_protein_dic[idi]+=name_list
            ...
            print(name_list)
            for idi in id_list:
                uniprot_kb_gene_dic[idi]+=name_list

json_file='./Glygen/OGER/uniprot_human_sprot_two_dic.json'
with open(json_file,'w') as outfile:
    json.dump([uniprot_kb_protein_dic,uniprot_kb_gene_dic],outfile)