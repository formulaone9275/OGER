...
def protein_detection_OGER(term_file,txt_file):
    ...
    txt_file='./Glygen/OGER/8172892.txt'

    entity_dic={}

    coll = pl.load_one(txt_file, 'txt')
    pl.process(coll)
    #print(coll[0][0].text)
    ...
    entity_dic['8172892']=entities_list_non_overlap
    return entity_dic
...
if __name__=='__main__':
    ...
    print(protein_detection_OGER(term_file,''))
